    ...
    if (user.emailStatus === "unconfirmed") {
      ...
      if (!user.emailChangeCandidate) {
        return res.serverError(
          undefined,
          `Consistency violation: Could not update customer because this user record's emailChangeCandidate ("${user.emailChangeCandidate}") is missing.  (This should never happen.)`
        );
      }
